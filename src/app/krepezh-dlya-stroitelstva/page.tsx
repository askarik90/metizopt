...
export const metadata: Metadata = {
  alternates: { canonical: "https://krp.kz/krepezh-dlya-stroitelstva" },
  openGraph: { url: "https://krp.kz/krepezh-dlya-stroitelstva" },
  title: "Крепеж для строительства оптом в Алматы | KRP",
