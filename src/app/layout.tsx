...
export const metadata: Metadata = {
  ...
  title: {
    ...
    // Без бренда в шаблоне: Google сам подставляет имя сайта, а лендинги уже содержат бренд
    // в своём title (иначе выходил двойной «| KRP»). Освобождает место под ключевики.
    template: "%s",
  },
  description:
