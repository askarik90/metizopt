...
export const CATEGORY_IMAGES: Record<string, string> = {
  ...
  "perfo-derzhatel-balki": C("perfo-opora"),
  "perfo-plastina-kp": C("perfo-plastina"),
  "perfo-ankernyi-ugol-kau": C("perfo-ugol"),
  "perfo-ugol-ku": C("perfo-ugol"),
  "perfo-ugol-kuas": C("perfo-ugol"),
  "perfo-ugol-kus": C("perfo-ugol"),
  "perfo-ugol-kur": C("perfo-ugol"),
  "perfo-ugol-kuu": C("perfo-ugol"),
  "perfo-ugol-kur-us": C("perfo-ugol"),
  "perfo-lenta": C("perfo-lenta"),
  "perfo-opora-balki": C("perfo-opora"),
  "perfo-lenta-lm": C("perfo-lenta"),
  "perfo-plastina-ps": C("perfo-plastina"),
  "perfo-prushina-pzp": C("perfo-prushina"),
  "perfo-uglovoy-soedinitel": C("perfo-soedinitel"),
  "perfo-ugol-mebelnyi": C("perfo-mebel"),
  // Электроды
